    ...
    public void onBindViewHolder(TaskViewHolder holder, int position) {
        ...
        if((mCursor == null) || (mCursor.getCount() == 0)) {
            ...
            final Task task = new Task(mCursor.getLong(mCursor.getColumnIndex(TaskContract.Column._ID)),
                    mCursor.getString(mCursor.getColumnIndex(TaskContract.Column.TASKS_NAME)),
                    mCursor.getString(mCursor.getColumnIndex(TaskContract.Column.TASKS_DESCRIPTION)),
                    mCursor.getInt(mCursor.getColumnIndex(TaskContract.Column.TASKS_SORTORDER)));
